...
lineaccesstoken = 'EilmiNbSZroEuhOEGsQlU2crmejAljf8NRudZEJOIE2D5XLapHYBI5ekoNcxkLeW+ioK3D2nokIyi+hulDSxr2gzToAKL6t+3WwhyMClP3x2VfGLcm4H3/4NSj5ASNjGB4mfJ8lfFoWZOntrqpC3DwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg =="สวัสดี" :
            replyObj = TextSendMessage(text="ดีคร้าบบ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg =="ฝนตกมั้ย" :
            ...
            url = "https://bots.dialogflow.com/line/f6a723e6-60a6-4e16-8084-167f7c8019b1/webhook"f6a723e6-60a6-4e16-8084-167f7c8019b1
